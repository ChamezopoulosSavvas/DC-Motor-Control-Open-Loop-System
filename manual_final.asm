...
; and by pressing the SW1 button to decrease the duty cycle
...
.def intervalOf4Pulses = r15 ; for measuring interval of 4 pulses
...
SLOW_DOWN:
	ldi xl, 0x72
	clr xh
	ld r16 , x			; 14 steps of 5% duty cycle decrease 
...
SKIP:
	...
	; wait for user to press sw6 to start measuring
	rcall GET_SW6
	rcall WAIT_FOR_RELEASE
...
SHOW_VALUES:
	...
	out PORTB, r16				; display value via leds
...
PRESS0:
	 in r16,PINC
     andi r16, 0b00000001   	; if sw0 is pressed then R16 with have zero value
	 cpi r16, 0
	 brne PRESS0 				; Loop if sw0 isn't pressed yet
	 pop r16	 
	 ret
...
PRESS1:
	 in r16,PINC
     andi r16, 0b00000010   	; if sw1 is pressed then R16 with have zero value
	 cpi r16, 0
	 brne PRESS1 				; Loop if sw1 isn't pressed yet
	 pop r16	 
	 ret
...
PRESS6:
	 in r16,PINC
     andi r16, 0b01000000   	; if sw6 is pressed then R16 with have zero value
	 cpi r16, 0
	 brne PRESS6 				; Loop if sw6 isn't pressed yet
	 pop r16	 
	 ret
